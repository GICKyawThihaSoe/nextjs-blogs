              ...
              <div className="md:grid md:grid-cols-2 md:gap-x-16 lg:gap-x-8 mb-20 md:mb-28">
                <div>
                  <h3 className="mb-4 text-4xl lg:text-6xl leading-tight">
                    <Link href="/posts/dynamic-routing" className="hover:underline">Dynamic Routing and Static Generation</Link>
                  </h3>
                    ...
                    <div className="sm:mx-0">
                      ...
                      <h3 className="text-3xl mt-5 mb-3 leading-snug">
                        ...
                        <p className="text-lg leading-relaxed mb-4">
                          ...
                          dolore magna aliqua. Praesent elementum facilisis leo
                          vel fringilla est ullamcorper eget. At imperdiet dui
